...
3. Download pacstrapit: `curl -k https://codeload.github.com/atweiden/{pacstrapit}/{tar.gz}/{0.3.7} -o "#1-#3.#2"`
4. Extract: `tar xvzf pacstrapit-0.3.7.tar.gz`
...
> `cd pacstrapit-0.3.7 && $EDITOR pacstrapit`
