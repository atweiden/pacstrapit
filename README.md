...
4. Download pacstrapit: `curl -k https://codeload.github.com/atweiden/{pacstrapit}/{tar.gz}/{0.9.1} -o "#1-#3.#2"`
5. Extract: `tar xvzf pacstrapit-0.9.1.tar.gz`
...
> `cd pacstrapit-0.9.1 && $EDITOR pacstrapit`
...
<tr><td>Perl6</td><td>Packages for programming in Perl 6</td></tr>
