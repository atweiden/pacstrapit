...
4. Download pacstrapit: `curl -k https://codeload.github.com/atweiden/{pacstrapit}/{tar.gz}/{0.5.8} -o "#1-#3.#2"`
5. Extract: `tar xvzf pacstrapit-0.5.8.tar.gz`
...
> `cd pacstrapit-0.5.8 && $EDITOR pacstrapit`
