...
3. Download pacstrapit: `curl -k https://codeload.github.com/atweiden/{pacstrapit}/{tar.gz}/{0.0.17} -o "#1-#3.#2"`
4. Extract: `tar xvzf pacstrapit-0.0.17.tar.gz`
...
> `cd pacstrapit-0.0.17 && $EDITOR pacstrapit`
